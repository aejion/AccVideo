    ...
    def __init__(self, model_name=None, device=0, is_vl=False, **kwargs):
        ...
        if self.is_vl:
            ...
            self.model = AutoModelForCausalLM.from_pretrained(
                ...
                attn_implementation="flash_attention_2"
                if FLASH_VER == 2 else None,
                device_map="cpu", cache_dir='/mnt/hwfile/opencompass/checkpoints/llm/hf_hub/')
            self.tokenizer = AutoTokenizer.from_pretrained(self.model_name, cache_dir='/mnt/hwfile/opencompass/checkpoints/llm/hf_hub/')
