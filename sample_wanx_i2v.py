...
from models.wan.utils.utils import cache_video, cache_image, str2bool
...
def generate(args):
    ...
    with open("./assets/prompt_i2v.txt") as f:
        prompts = f.readlines()
    ...
    for idx, prompt in enumerate(prompts):
        ...
        img = Image.open(f"./assets/images/{idx}.png").convert("RGB")
        if os.path.exists(save_file): continue
        start_time = time.time()
        videos, denoise_latents, arg_c = wan_i2v.generate(
            prompt,
            img,
